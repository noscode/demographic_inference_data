...
n_pop = 5
pop_labels = ["YRI", "CEU", "CHB", "KHV", "JPT"]
par_labels = ['nuAf', 'nuB', 'nuEu0', 'nuEu', 'nuAs0', 'nuAs',
              'nuKHV0', 'nuKHV', 'nuJp0', 'nuJp',
              'mAfB', 'mAfEu', 'mAfAs', 'mEuAs', 'mChKHV', 'mChJp',
              'TAf', 'TB', 'TEuAs', 'TChKHV', 'TChJp']
...
# N_KHV0 = 2356
# r_KHV = 0.174 # It looks like some error so we used T=800/29 gen. to convert
# N_Jp0 = 4384
...
popt = [2.100504737447977, 0.25068626582838927, 0.2224386788275923,
        ...
        0.20862481183033738, 17.427877292714193,
        0.38820508279465155, 20.730881823465822, 3.7944479999999996,
        0.2574804, 0.1264816, 1.072835, 4.810818,
        0.7453380000000001, 0.3633621071338058, 0.11145140260826816,
        0.05526768184136038, 0.00122138523406321, 0.013740583883211146]

lower_bound = [1e-2, 1e-2, 1e-2, 1e-2, 1e-2, 1e-2, 1e-2, 1e-2, 1e-2, 1e-2,
               0, 0, 0, 0, 0, 0, 1e-15, 1e-15, 1e-15, 1e-15, 1e-15]
upper_bound = [100, 100, 100, 100, 100, 100, 100, 100, 100, 100,
...
if __name__ == "__main__":
    ...
    moments.ModelPlot.plot_model(model,
        ...
        fig_title=f'Demographic model for 5_YRI_CEU_CHB_JPT_KHV_21_Jou',
