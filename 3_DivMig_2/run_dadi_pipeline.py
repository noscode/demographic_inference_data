...
def run_one_job(prefix):	
	...
	Optimize_Functions.Optimize_Routine(data, [40,50,50], path_to_dir + '/prefix', 'our_model', func, 2, 9, False, reps=[10, 20])
...
try:
        result = []
#2489,100000000
        map_result = pool.map_async(run_one_job, [str(i) for i in xrange(1, 11)], callback=result.extend)
        while True:
                try:
