...
popt = [9989.4660170128627, 13260.272953736603, 5179.8271580520213, 16112.333171372218, 4961.5111076850453, 10095.153270706542, 1114.7427994024242, 482.66679968862951, 0.00011989613988540882, 1.9311681448141271e-05, 3.5280234702241428e-05, 7.0423934210191519e-05, 4.8628650245840641e-05, 0.00028585742083221362, 9.8696522105543903e-05, 0.00027235644764340468]
ns = [20, 20, 20]
model = generated_model(popt, ns)
ll_model = moments.Inference.ll(model, data)
print('Model log likelihood (LL(model, data)): {0}'.format(ll_model))
#now we need to norm vector of params so that N_A is 1:
popt_norm = [1.0, 1.3274256032457885, 0.51852893330137562, 1.6129323773594726, 0.49667430663813195, 1.0105798701866231, 0.11159183058473073, 0.04831757762292891, 1.1976984149563119, 0.192913385557585, 0.35243070563027867, 0.70349749757705782, 0.48577424908402927, 2.855562991114343, 0.98592555357068967, 2.7206954782481341]
