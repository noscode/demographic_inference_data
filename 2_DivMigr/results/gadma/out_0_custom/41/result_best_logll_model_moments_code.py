#current best params = [0.99957438989948533, 0.10071568303447177, 5.0073463690064104, 2.5000116255131903, 0.050509055733205174]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [0.99957438989948533, 0.10071568303447177, 5.0073463690064104, 2.5000116255131903, 0.050509055733205174]
ns = [20, 20]
model = generated_model(popt, ns)
Nref = 0.0505090557332# It is also optimized parameter by GADMA
