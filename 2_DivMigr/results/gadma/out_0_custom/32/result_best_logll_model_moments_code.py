#current best params = [0.99604789784824876, 0.10195677572012933, 5.0274797566980016, 2.4657107593181125, 0.051323199447270339]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [0.99604789784824876, 0.10195677572012933, 5.0274797566980016, 2.4657107593181125, 0.051323199447270339]
ns = [20, 20]
model = generated_model(popt, ns)
Nref = 0.0513231994473# It is also optimized parameter by GADMA
