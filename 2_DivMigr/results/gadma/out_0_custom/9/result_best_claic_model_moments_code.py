#current best params = [0.99688177112351062, 0.10363755936553253, 5.0506655120616983, 2.3529185417977159, 0.051917370492075822]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [0.99688177112351062, 0.10363755936553253, 5.0506655120616983, 2.3529185417977159, 0.051917370492075822]
ns = [20, 20]
model = generated_model(popt, ns)
Nref = 0.0519173704921# It is also optimized parameter by GADMA
