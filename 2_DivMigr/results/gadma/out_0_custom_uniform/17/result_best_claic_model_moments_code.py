#current best params = [1.0000974211403384, 0.10118526898092496, 5.0067809019391625, 2.5089163320527161, 0.050876635172947916]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [1.0000974211403384, 0.10118526898092496, 5.0067809019391625, 2.5089163320527161, 0.050876635172947916]
ns = [20, 20]
model = generated_model(popt, ns)
Nref = 0.0508766351729# It is also optimized parameter by GADMA
