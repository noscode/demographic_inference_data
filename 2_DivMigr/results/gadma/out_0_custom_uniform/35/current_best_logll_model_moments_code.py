#current best params = [1.0021872869507269, 0.0984198240591969, 4.9698256726352854, 2.5805531940694038, 0.049212035878389841]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [1.0021872869507269, 0.0984198240591969, 4.9698256726352854, 2.5805531940694038, 0.049212035878389841]
ns = [20, 20]
model = generated_model(popt, ns)
Nref = 0.0492120358784# It is also optimized parameter by GADMA
