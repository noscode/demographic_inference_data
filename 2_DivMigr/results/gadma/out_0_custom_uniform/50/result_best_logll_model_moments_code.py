#current best params = [0.99962812327318107, 0.10075490649036005, 5.012385100562466, 2.4404198684897453, 0.050273585712762303]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [0.99962812327318107, 0.10075490649036005, 5.012385100562466, 2.4404198684897453, 0.050273585712762303]
ns = [20, 20]
model = generated_model(popt, ns)
Nref = 0.0502735857128# It is also optimized parameter by GADMA
