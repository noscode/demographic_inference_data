#current best params = [0.99889997863956415, 0.10074910322529645, 5.0147632793563872, 2.459636505628902, 0.050360352746135893]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [0.99889997863956415, 0.10074910322529645, 5.0147632793563872, 2.459636505628902, 0.050360352746135893]
ns = [20, 20]
model = generated_model(popt, ns)
Nref = 0.0503603527461# It is also optimized parameter by GADMA
