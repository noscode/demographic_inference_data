#current best params = [0.9974598449559845, 0.10007996620067162, 5.0174184928768, 2.4667546871020636, 0.049934150952325597]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [0.9974598449559845, 0.10007996620067162, 5.0174184928768, 2.4667546871020636, 0.049934150952325597]
ns = [20, 20]
model = generated_model(popt, ns)
Nref = 0.0499341509523# It is also optimized parameter by GADMA
