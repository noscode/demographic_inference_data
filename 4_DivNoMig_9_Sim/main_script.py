...
lower_bound = [1e-2, 1e-2, 1e-2, 1e-2, 1e-2, 1e-2, 1e-15, 1e-15, 1e-15]
upper_bound = [100, 100, 100, 100, 100, 100, 5, 5, 5]
...
if __name__ == "__main__":
    ...
    moments.ModelPlot.plot_model(model,
        ...
        fig_title=f'Demographic model for 4_DivNoMig_9_Sim, Nanc: {Nanc}',
