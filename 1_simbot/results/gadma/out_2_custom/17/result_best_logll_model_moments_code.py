#current best params = [100.0, 100.0, 0.068127247325839121, 0.082936987106789997]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [100.0, 100.0, 0.068127247325839121, 0.082936987106789997]
ns = [20]
...
popt_norm = [100.0, 100.0, 0.068127247325839121, 0.082936987106789997]
theta0 = 2.0
