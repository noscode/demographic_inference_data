#current best params = [100.0, 99.99999999982623, 0.15047682063055484, 0.00058736046308132664]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [100.0, 99.99999999982623, 0.15047682063055484, 0.00058736046308132664]
ns = [20]
...
popt_norm = [100.0, 99.99999999982623, 0.15047682063055484, 0.00058736046308132664]
theta0 = 2.0
