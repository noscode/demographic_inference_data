#current best params = [22.543432031010532, 0.42984677647212477, 5.0, 1.2002760077573895]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [22.543432031010532, 0.42984677647212477, 5.0, 1.2002760077573895]
ns = [20]
...
popt_norm = [22.543432031010532, 0.42984677647212477, 5.0, 1.2002760077573895]
theta0 = 2.0
