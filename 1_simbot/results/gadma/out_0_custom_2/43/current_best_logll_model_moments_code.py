#current best params = [0.02697923312888479, 1.0226710363726355, 0.013898902512662105, 0.047831432624411863]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [0.02697923312888479, 1.0226710363726355, 0.013898902512662105, 0.047831432624411863]
ns = [20]
model = generated_model(popt, ns)
Nref = 0.0478314326244# It is also optimized parameter by GADMA
