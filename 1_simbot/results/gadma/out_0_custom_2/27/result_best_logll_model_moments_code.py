#current best params = [0.019574360682055172, 1.007320069550258, 0.0099026052910077128, 0.049174001710496754]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [0.019574360682055172, 1.007320069550258, 0.0099026052910077128, 0.049174001710496754]
ns = [20]
model = generated_model(popt, ns)
Nref = 0.0491740017105# It is also optimized parameter by GADMA
