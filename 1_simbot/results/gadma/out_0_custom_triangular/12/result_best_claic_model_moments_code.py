#current best params = [25.626264874603947, 0.42311112352094715, 5.0, 1.1952280000019435]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [25.626264874603947, 0.42311112352094715, 5.0, 1.1952280000019435]
ns = [20]
model = generated_model(popt, ns)
Nref = 1.195228# It is also optimized parameter by GADMA
