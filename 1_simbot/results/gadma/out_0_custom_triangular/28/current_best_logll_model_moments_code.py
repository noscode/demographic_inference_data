#current best params = [3.7938295208251986, 0.11171694172055693, 5.0, 0.40692361242994352]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [3.7938295208251986, 0.11171694172055693, 5.0, 0.40692361242994352]
ns = [20]
model = generated_model(popt, ns)
Nref = 0.40692361243# It is also optimized parameter by GADMA
