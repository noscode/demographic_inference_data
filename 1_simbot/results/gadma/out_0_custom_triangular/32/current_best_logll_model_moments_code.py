#current best params = [36.241052423179681, 0.42206246257468422, 5.0, 1.2085006657304869]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [36.241052423179681, 0.42206246257468422, 5.0, 1.2085006657304869]
ns = [20]
model = generated_model(popt, ns)
Nref = 1.20850066573# It is also optimized parameter by GADMA
