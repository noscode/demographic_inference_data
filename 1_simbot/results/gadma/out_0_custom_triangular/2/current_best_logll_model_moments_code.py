#current best params = [43.588798095838534, 0.1460455235793823, 5.0, 0.5835633492391441]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [43.588798095838534, 0.1460455235793823, 5.0, 0.5835633492391441]
ns = [20]
model = generated_model(popt, ns)
Nref = 0.583563349239# It is also optimized parameter by GADMA
