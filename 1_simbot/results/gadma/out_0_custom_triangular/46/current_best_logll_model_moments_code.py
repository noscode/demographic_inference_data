#current best params = [23.168340974341458, 0.15893492374246676, 4.9999999999999991, 0.61199049185060694]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [23.168340974341458, 0.15893492374246676, 4.9999999999999991, 0.61199049185060694]
ns = [20]
model = generated_model(popt, ns)
Nref = 0.611990491851# It is also optimized parameter by GADMA
