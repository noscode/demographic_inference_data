#current best params = [9.9345054930705814, 0.20574800676334887, 4.9999999999999991, 0.70383320502962998]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [9.9345054930705814, 0.20574800676334887, 4.9999999999999991, 0.70383320502962998]
ns = [20]
model = generated_model(popt, ns)
Nref = 0.70383320503# It is also optimized parameter by GADMA
