#current best params = [12.350563288829207, 0.20900379712333433, 4.9999999999999991, 0.72259117192895117]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [12.350563288829207, 0.20900379712333433, 4.9999999999999991, 0.72259117192895117]
ns = [20]
model = generated_model(popt, ns)
Nref = 0.722591171929# It is also optimized parameter by GADMA
