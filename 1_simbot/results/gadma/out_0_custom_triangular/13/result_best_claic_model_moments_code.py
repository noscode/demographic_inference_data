#current best params = [5.7492329484677729, 0.071678703434822008, 5.0, 0.3091245428262282]
import matplotlib
matplotlib.use("Agg")
import moments
import numpy as np
...
popt = [5.7492329484677729, 0.071678703434822008, 5.0, 0.3091245428262282]
ns = [20]
model = generated_model(popt, ns)
Nref = 0.309124542826# It is also optimized parameter by GADMA
